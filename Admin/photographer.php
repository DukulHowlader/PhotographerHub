    ...
    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left: 6%;">
        ...
        <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="admin.php"> <i class="fas fa-user"></i> <?php echo $_SESSION['admin_name']?></a>
...
<div class="table-responsive">  
                     <table id="photographer_data" class="table table-striped table-bordered">  
                          <thead>  
                               <tr>  
                                    <td>Name</td>  
                                    <td>Email</td>  
                          ...
                          {  
                               ...
                               <tr id='.$row["Email"].'>  
                                    ...
                                    <td> <input type="button" name="view"  value="Delete" id="'.$row["Email"].'" class="btn btn-danger btn-xs delete"/>
                                    </td>  
