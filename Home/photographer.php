<?php
 ...
 if (isset($_SESSION['is_log_in'])) {
   ...
   {  
        ...
        $query1 = "INSERT INTO tbl_images(name,Email) VALUES ('$file','".$_SESSION["email"]."')";  
        if(mysqli_query($conn, $query1))  
        {  
             echo '<script> swal("Image Uploaded","","success");</script>';  
        }  
   }  
?>
<!DOCTYPE html>
           ...
           <div class="card" >
            ...
            <br />
              <form method="post" enctype="multipart/form-data">  
                ...
                <?php  
                $query_q = "SELECT * FROM tbl_images WHERE Email = '".$_SESSION["email"]."'  ORDER BY id DESC";  
                $result = mysqli_query($conn, $query_q);  
